...
- **自定义 API 与多模型切换** - 在设置中添加任意 OpenAI 兼容端点，与内置模型统一管理
- **Token 用量看板** - 每个浮窗独立显示上下文 Token 用量，内置模型定价精确估算成本
...
- **自定义 API 多模型** - 运行时添加任意 OpenAI 兼容端点与模型，与内置模型统一调度
