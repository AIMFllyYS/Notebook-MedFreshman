...
export async function GET(request:Request){
 ...
 asr:!!((process.env.CLASS_ASR_BASE_URL||process.env.ASR_BASE_URL)&&(process.env.CLASS_ASR_API_KEY||process.env.ASR_API_KEY)&&(process.env.CLASS_ASR_MODEL||process.env.ASR_MODEL)&&Number(process.env.CLASS_ASR_CNY_PER_SECOND)>0),
