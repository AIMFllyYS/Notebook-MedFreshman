...
import { BookmarkCheck, MonitorPlay, MoreHorizontal, ImagePlus, PieChart, FileText, BookOpen } from "lucide-react";
...
function WindowIcon({ type }: { type: ManagedWindow["type"] }) {
  ...
  if (type === "note-citation-viewer") return <BookOpen size={14} />;
