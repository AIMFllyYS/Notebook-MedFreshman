...
interface PencilSparklesIconProps extends Omit<SVGProps<SVGSVGElement>, "width" | "height"> {
  size?: number;
}

export default function PencilSparklesIcon({ size = 24, ...props }: PencilSparklesIconProps) {
  return (
    <svg
