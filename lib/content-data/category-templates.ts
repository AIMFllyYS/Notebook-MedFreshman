...
import type { Category, CategoryCapability, CategoryKeyStrategy, ContentItem, LayoutProfile } from '@/lib/types/content';
...
export function category(
  ...
  return {
    ...
    ...('layoutProfile' in tpl ? { layoutProfile: tpl.layoutProfile } : {}),
    ...overrides,
    items,
  };
}
