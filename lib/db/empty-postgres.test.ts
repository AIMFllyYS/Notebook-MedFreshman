...
test("empty PGlite migrate equals live catalog snapshot", { timeout: 60_000 }, async () => {
  ...
  assert.deepEqual(result.applied, ["0001", "0002", "0003", "0004", "0005", "0006", "0007", "0008", "0009"]);
  assert.deepEqual(result.replay, {
    applied: [],
    skipped: ["0001", "0002", "0003", "0004", "0005", "0006", "0007", "0008", "0009"],
  });
  assert.equal(result.currentVersion, "0009");
  ...
  assert.equal(result.status.applied[8]?.version, "0009");
