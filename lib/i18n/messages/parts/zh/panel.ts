...
export const panelZh = {
  ...
  membership: {
    ...
    pay: {
      title: "在线升级",
      hint: "在 Creem 安全页面完成支付，成功后额度自动到账。",
      monthly: "月付",
      yearly: "年付",
      quotaMonthly: "每月 {quota} 元模型额度",
      monthsUnit: "{n} 个月",
      cta: "去支付",
      busy: "正在创建支付…",
      signInRequired: "请先登录后再购买会员。",
      notConfigured: "在线支付暂未开放，可先联系站长升级。",
      invalidPlan: "该档位暂未开放。",
      failed: "创建支付失败，请稍后再试。",
    },
    payReturn: {
      title: "支付结果",
      checking: "正在确认支付结果…",
      waiting: "等待支付确认中，完成支付后会自动开通。",
      success: "支付成功",
      successDesc: "{tier} 会员已开通，额度已到账。",
      pending: "支付确认中",
      pendingDesc: "支付已收到，额度正在入账，请稍后查看会员状态。",
      failed: "支付未完成",
