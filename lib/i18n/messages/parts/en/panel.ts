...
export const panelEn = {
  ...
  membership: {
    ...
    pay: {
      ...
      hint: "Checkout happens on Creem's secure page; quota lands automatically after payment.",
      monthly: "Monthly",
      yearly: "Yearly",
      quotaMonthly: "{quota} CNY quota / month",
      monthsUnit: "{n} months",
      cta: "Checkout",
      busy: "Creating checkout…",
      signInRequired: "Sign in first to purchase membership.",
      notConfigured: "Online checkout isn't live yet — contact the maintainer.",
      invalidPlan: "That plan isn't available yet.",
      failed: "Checkout failed. Please try again later.",
    },
    payReturn: {
      title: "Payment result",
      checking: "Confirming your payment…",
      waiting: "Waiting for payment confirmation — membership activates automatically once paid.",
      success: "Payment successful",
      successDesc: "{tier} membership is active and quota has been granted.",
      pending: "Confirming payment",
      pendingDesc: "Payment received; quota is being granted. Check membership status shortly.",
